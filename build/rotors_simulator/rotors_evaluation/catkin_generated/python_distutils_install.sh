...
echo_and_run cd "/home/alan/Plant_UAV/src/rotors_simulator/rotors_evaluation"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/alan/Plant_UAV/src/rotors_simulator/rotors_evaluation/setup.py" \
     \
    build --build-base "/home/alan/Plant_UAV/build/rotors_simulator/rotors_evaluation" \
    install \
    --root="${DESTDIR-/}" \
