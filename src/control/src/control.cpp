...
float linear_smoothing_navigation_step = 1.0;
...
int main(int argc, char** argv) {
    ...
    // TODO:give a rectangle, auto traverse the entire region
    std::vector<Eigen::Vector3d> path;
    path.push_back(Eigen::Vector3d(5.f,0.f,2.f));
    path.push_back(Eigen::Vector3d(5.f,2.f,2.f));
    path.push_back(Eigen::Vector3d(-5.f,2.f,2.f));
    path.push_back(Eigen::Vector3d(-5.f,4.f,2.f));
    path.push_back(Eigen::Vector3d(5.f,4.f,2.f));
    path.push_back(Eigen::Vector3d(5.f,6.f,2.f));
    path.push_back(Eigen::Vector3d(-5.f,6.f,2.f));
    ...
    { 
        if(flag_gps_initialized_OK && !flag_take_off_OK)
        {
            ...
            flag_take_off_OK = takeOffTask(2);
        }
